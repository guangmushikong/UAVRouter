...
#include <niGeom/math/niMatrix44.h>
double niMatrix44::Det() const
{
    double A0 = M[5] * M[10] - M[6] * M[9];
    double A1 = M[6] * M[8] - M[4] * M[10];
    double A2 = M[4] * M[9] - M[5] * M[8];
...
bool niMatrix44::Inverse()
{
    return true;
}

void niMatrix44::FromAxisAngle(const niVector3d& axis, double angle)
{
    if ( cos(angle) < 1-ZEROD )
    {
        niMatrix33 rot;
...
//-----------------------------------------------------------------------
void niMatrix44::ToAxisAngle(niVector3d& axis, double& angle) const
{
...
//-----------------------------------------------------------------------
bool niMatrix44::ToEulerAnglesXYZ(niRotate3d &rot) const
{
    // rot =  cy*cz          -cy*sz           sy
...
//-----------------------------------------------------------------------
bool niMatrix44::ToEulerAnglesXZY(niRotate3d &rot) const
{
    // rot =  cy*cz          -sz              cz*sy
...
//-----------------------------------------------------------------------
bool niMatrix44::ToEulerAnglesYXZ(niRotate3d &rot) const
{
...
//-----------------------------------------------------------------------
bool niMatrix44::ToEulerAnglesYZX(niRotate3d &rot) const
{
...
//-----------------------------------------------------------------------
bool niMatrix44::ToEulerAnglesZXY(niRotate3d &rot) const
{
...
//-----------------------------------------------------------------------
bool niMatrix44::ToEulerAnglesZYX (niRotate3d &rot) const
{
...
//-----------------------------------------------------------------------
void niMatrix44::FromEulerAnglesXYZ(const niRotate3d &rot)
{
    niMatrix33 tm;
...
//-----------------------------------------------------------------------
void niMatrix44::FromEulerAnglesXZY(const niRotate3d &rot)
{
    niMatrix33 tm;
...
//-----------------------------------------------------------------------
void niMatrix44::FromEulerAnglesYXZ(const niRotate3d &rot)
{
    niMatrix33 tm;
...
//-----------------------------------------------------------------------
void niMatrix44::FromEulerAnglesYZX(const niRotate3d &rot)
{
    niMatrix33 tm;
...
//-----------------------------------------------------------------------
void niMatrix44::FromEulerAnglesZXY(const niRotate3d &rot)
{
    niMatrix33 tm;
...
//-----------------------------------------------------------------------
void niMatrix44::FromEulerAnglesZYX(const niRotate3d &rot)
{
    niMatrix33 tm;
